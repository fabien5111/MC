  ...
  return (
    <ul className="mt-1 flex flex-col gap-2">
      {photos.map((p, i) => (
        ...
        >
          <span
            className={`shrink-0 w-6 h-6 rounded-full bg-primary text-on-primary font-label-md text-[12px] flex items-center justify-center ${
          ...
          <img
            src={p.url}
            alt=""
            className="shrink-0 w-14 h-14 rounded-lg object-cover border border-outline-variant pointer-events-none"
          />
