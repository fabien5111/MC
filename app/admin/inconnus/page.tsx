...
import { getUnknownIngredients, getUnknownUtensils, getListEntries } from '@/lib/admin';
...
export default async function AdminInconnusPage() {
  ...
  const [ingredients, utensils, allergensRaw] = await Promise.all([
  ...
  return (
    <>
      ...
      <UnknownItemsManager ingredients={ingredients} utensils={utensils} allergens={allergens} />
    </>
  );
}
